            ...
            <div className="col-md-12">
              <ButtonToolbar>
                <ButtonGroup>
                  ...
                  <Button bsStyle ="primary" value = "Playoff Points Champion" onClick = {this.handleTrophySelection}>Points Champiom</Button>

                </ButtonGroup>
                <ButtonGroup>
                  <h5>Regular Season</h5>
                  <Button bsStyle ="primary" value = "Points Winner" onClick = {this.handleTrophySelection}>Points Champion</Button>
